...
import { Stack, Heading, Text, Input, Button, AlertBar } from "@inquizitor/ui";
...
const ForgotPasswordPage: React.FC = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      setSuccessMessage(
        "Jeśli podany adres e-mail istnieje w naszym systemie, wysłaliśmy na niego link do zresetowania hasła."
      );
    } catch (err: any) {
      setErrorMessage(
        err?.message || "Nie udało się zlecić resetowania hasła."
      );
    } finally {
      setLoading(false);
    }
        ...
        <Stack $gap="lg">
          ...
          {successMessage ? (
            <Stack $gap="lg">
              ...
              <Text $variant="body2" $tone="muted">
                Jeśli nie widzisz wiadomości, sprawdź folder Spam. Link jest
